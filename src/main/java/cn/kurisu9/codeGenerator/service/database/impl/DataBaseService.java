package cn.kurisu9.codeGenerator.service.database.impl;
    ...
    public List<ModelInfo> loadModelInfos(DataBaseConfig dataBaseConfig, CodeGeneratorConfig codeGeneratorConfig) {
        ...
        try {
            ...
            while(tableRs.next()) {
                ...
                // 允许model的名称进行格式化
                modelInfo.setModelName(String.format(codeGeneratorConfig.getModelNameFormat(), convertToModelName(tableName)));
