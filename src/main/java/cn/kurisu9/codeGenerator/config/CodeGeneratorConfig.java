package cn.kurisu9.codeGenerator.config;
...
public class CodeGeneratorConfig {
    ...
    public String getModelNameFormat() {
        return modelNameFormat;
    }

    public void setModelNameFormat(String modelNameFormat) {
        this.modelNameFormat = StringUtil.isNullOrEmpty(modelNameFormat) ? "%s" : modelNameFormat;
    }
