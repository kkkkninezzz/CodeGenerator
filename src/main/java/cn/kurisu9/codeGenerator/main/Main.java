package cn.kurisu9.codeGenerator.main;

import cn.kurisu9.codeGenerator.service.main.ICodeGeneratorService;
import cn.kurisu9.codeGenerator.service.main.generator.classFile.impl.DtoGenerator;
import cn.kurisu9.codeGenerator.service.main.generator.classFile.impl.ModelGenerator;
import cn.kurisu9.codeGenerator.service.main.generator.controller.ControllerGenerator;
import cn.kurisu9.codeGenerator.service.main.generator.defaultClasses.DefaultClassesGenerator;
import cn.kurisu9.codeGenerator.service.main.generator.iservice.IServiceGenerator;
import cn.kurisu9.codeGenerator.service.main.generator.mapper.MapperGenerator;
import cn.kurisu9.codeGenerator.service.main.generator.mapperXml.MapperXmlGenerator;
import cn.kurisu9.codeGenerator.service.main.generator.serviceImpl.ServiceImplGenerator;
import cn.kurisu9.codeGenerator.service.main.impl.CodeGeneratorService;
